...
SECRET_KEY = 'django-insecure-@x9*1du82b6vg3e$=y@!mhkvrl5cbvk&(%3g6!$#jwi84!jqtk'
...
CSRF_COOKIE_SAMESITE = 'Lax'  # Ensure this matches your JWT cookie settings
...
WSGI_APPLICATION = 'my_JWT.wsgi.application'
